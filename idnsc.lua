...
-- Icon Configuration (Downloads raw image URL to local custom asset for Roblox):
local RawImageURL = "https://raw.githubusercontent.com/nanamm19991234-dev/idnsc/refs/heads/main/idn%20logo.png"
local function GetOnlineIcon(url)
    local getasset = (getcustomasset or getsynasset or function(a) return a end)
    local filename = "idn_logo_downloaded.png"
    pcall(function()
...
local idnIcon = GetOnlineIcon(RawImageURL)


local redzlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/nanamm19991234-dev/idnsc/refs/heads/main/idnscui.lua"))()
