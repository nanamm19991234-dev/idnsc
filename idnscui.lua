...
ColorSequenceKeypoint.new(0.50,Color3.fromRGB(15,30,55)),
ColorSequenceKeypoint.new(1.00,Color3.fromRGB(10,20,35))
},
Primary=Color3.fromRGB(56,132,246),
OnPrimary=Color3.fromRGB(30,90,190),
ScrollBar=Color3.fromRGB(56,132,246),
Stroke=Color3.fromRGB(255,255,255),
Error=Color3.fromRGB(255,65,75),
Icons=Color3.fromRGB(255,255,255),
JoinButton=Color3.fromRGB(56,132,246),
Link=Color3.fromRGB(80,160,255),
Dialog={Background=Color3.fromRGB(10,20,35)},
Buttons={Holding=Color3.fromRGB(25,55,100),Default=Color3.fromRGB(15,35,65)},
Border={Holding=Color3.fromRGB(255,255,255),Default=Color3.fromRGB(255,255,255)},
Text={Default=Color3.fromRGB(255,255,255),Dark=Color3.fromRGB(220,230,255),Darker=Color3.fromRGB(180,200,235)},
Slider={SliderBar=Color3.fromRGB(56,132,246),SliderNumber=Color3.fromRGB(255,255,255)},
Dropdown={Holder=Color3.fromRGB(10,20,35)}
},
Icons={
...
self.Closed=true
pcall(function()
local aM=J(aB,"Position",UDim2.fromScale(3,0),0.35)
aM:Play()
aM.Completed:Connect(function()
aA:Destroy()
end)
end)
...
pcall(function()
local iconRes = s:GetIconByName(ay or af)
if iconRes then
aG.Image = iconRes
else
aG.Image = ay or ""
...
if not (ay and type(ay)=="string" and (O(ay) or ay:find("://",1,true) or ay:find(".",1,true))) then
if not iconRes then
aG.Visible=false
...
local timerVal = az or 5
task.spawn(function()
while timerVal > 0 and not aL.Closed do
aH.Text=Q(timerVal)
timerVal -= task.wait(0.1)
end
